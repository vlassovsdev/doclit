...
dnf install -y -qq \
    ...
    tesseract tesseract-langpack-rus tesseract-langpack-kaz \
    mesa-libGL glib2 libjpeg-turbo-devel zlib-devel \
    make gcc
